...
class JiankangController extends CommonController {
	...
	public function del(){
		...
		$info = M("Jiankang")->where("id = $id")->delete();
	...
	public function edit(){
		...
		$info = M("Jiankang")->where("id = $id")->find();
	...
	public function editAction(){
		...
		$info = M("Jiankang")->where("id = $id")->save($_POST);
