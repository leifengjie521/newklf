...
class YangshengController extends CommonController {
	...
	public function del(){
		...
		$info = M("Yangsheng")->where("id = $id")->delete();
	...
	public function edit(){
		...
		$info = M("Yangsheng")->where("id = $id")->find();
	...
	public function editAction(){
		...
		$info = M("Yangsheng")->where("id = $id")->save($_POST);
