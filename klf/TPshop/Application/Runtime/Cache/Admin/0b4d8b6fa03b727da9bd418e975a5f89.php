...
<div class="pageContent">
	<form method="post" action="<?php echo U('Tijianone/editAction');?>?callbackType=closeCurrent" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone)">
		<div class="pageFormContent nowrap" layoutH="97" >
				...
				<dl>
					...
					<dd>
						...
						<input type="hidden" name="id" maxlength="20" class="required" value="<?php echo ($info["id"]); ?>" />
					</dd>
				</dl>
